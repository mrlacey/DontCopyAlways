...
namespace DontCopyAlways
{
    ...
    [InstalledProductRegistration("Don't Copy Always", "Check for files that have 'Copy to output directory' set to 'Copy always'.", "1.3")] // Info on this package for Help/About
